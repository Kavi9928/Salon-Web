...
<section class="checkout-form">
   ...
   <form action="payment-method.php" method="post"> <!-- Modified action attribute to redirect to payment-method.php -->
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>city</span>
            <input type="text" placeholder="e.g. ratmalana" name="city" required>
         </div>
         <div class="inputBox">
            <span>state</span>
